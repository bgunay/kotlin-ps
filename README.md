...
and verbose fixed. 
* V5 (branch) webclient used instead of restClient and runBlocking removed and suspend controller fun used. springmockk lib used instead of mockito. GlobalExceptionHandler does not work in Controller tests. Will be fixed
